...
import { selectInitialScreen, changeHomeScreen } from "../../redux/preferences";
import { GLOBAL_STYLES, TYPOGRAPHY } from "../../styles";
import { HomeTabIcon, PortfolioTabIcon, DiscoverTabIcon, MarketTabIcon } from "../../navigators/BottomTabIcons";
...
const mapStateToProps = (state) => ({
  currentHomeScreen: selectInitialScreen(state)
});
