...
export const startPortfolioFetch = () => ({
...
export const deleteTransactionByIdSuccess = (
  updatedTransactions,
  successMsg
) => ({
...
export const startUpdatingTransactionById = (
  transactionId,
  updatedTransaction,
  index
) => ({
...
export const updateTransactionByIdSuccess = (
  updatedTransactions,
  successMsg
) => ({
