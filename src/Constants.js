...
const CONSTANTS = {
  ...
  SETTINGS: {
    ...
    LAUNCH_SCREEN_BACKGROUND_COLOR: "#1471ff",
    TERMS_AND_PRIVACY_BACKGROUND_COLOR: "#44484b",
    VERSION_BACKGROUND_COLOR: "#1471ff",
    CHANGE_PASSWORD_BACKGROUND_COLOR: "#1471ff",
    CHANGE_EMAIL_BACKGROUND_COLOR: "#4ecf3b",
    CHANGE_NAME_BACKGROUND_COLOR: "#44484b",
    LOG_OUT_BACKGROUND_COLOR: "#f85a27",
