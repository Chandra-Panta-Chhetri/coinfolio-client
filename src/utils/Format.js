...
export const toISOSubstring = (date) => (isNullOrUndefined(date) ? "" : date.toISOString().substring(0, 10));
...
export const formatDate = (isoString) => new Date(isoString)?.toDateString();
